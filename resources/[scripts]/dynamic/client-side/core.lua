...
RegisterCommand("PlayerFunctions",function()
	...
	if LocalPlayer.state.Prison then
		TriggerEvent("Notify","Atenção","Você não pode usar o menu de interações enquanto estiver preso.","amarelo",5000)
		return
	end
...
RegisterCommand("EmergencyFunctions",function()
	if LocalPlayer.state.Prison then
		TriggerEvent("Notify","Atenção","Você não pode usar o menu de emergência enquanto estiver preso.","amarelo",5000)
		return
	end
