...
Location = {
	{
		...
		Coords = vec3(474.52,-994.00,26.27),
		Mode = "Policia",
		Circle = 0.1
	},{
		Coords = vec3(380.42,799.48,190.49),
		Mode = "Policia",
		Circle = 0.1
	},{
...
List = {
	...
	Miners = {
		...
		List = {
			...
			handcuff = 25,
			ballisticplate = 750,
			WEAPON_NIGHTSTICK = 350,
			bandage = 200,
			medkit = 500,
			radio = 500,
			WEAPON_STUNGUN = 500,
			WEAPON_COMBATPISTOL = 5500,
			WEAPON_HEAVYPISTOL = 6500,
			WEAPON_SMG = 11500,
			WEAPON_SMG_MK2 = 13500,
			WEAPON_CARBINERIFLE = 21000,
			WEAPON_CARBINERIFLE_MK2 = 22500,
			WEAPON_SPECIALCARBINE = 21000,
			WEAPON_PUMPSHOTGUN = 12500,
			WEAPON_PISTOL_AMMO = 12,
			WEAPON_SMG_AMMO = 18,
			WEAPON_RIFLE_AMMO = 22,
			WEAPON_SHOTGUN_AMMO = 40,
			ATTACH_FLASHLIGHT = 1800,
			ATTACH_SILENCER = 4200,
			ATTACH_MAGAZINE = 2000,
			ATTACH_GRIP = 1500,
			ATTACH_CROSSHAIR = 2500
		}
	},		
}